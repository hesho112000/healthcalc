...
const GEO_ENTRIES: GeoEntry[] = [
  ...
  { re: /^Africa\/Johannesburg/i, cuisine: 'south_african', countryEn: 'South Africa', countryAr: 'جنوب أفريقيا' },
  { re: /^Africa\/Kigali/i, cuisine: 'rwandan', countryEn: 'Rwanda', countryAr: 'رواندا' },
  { re: /^Africa\/Nairobi/i, cuisine: 'kenyan', countryEn: 'Kenya', countryAr: 'كينيا' },
