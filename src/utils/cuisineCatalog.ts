...
export type MealType = 'breakfast' | 'lunch' | 'dinner' | 'snack' | 'fruit' | 'juice' | 'side' | 'salad' | 'drink';
...
export const PORTION_BY_MEALTYPE: Record<MealType, Portion> = {
  ...
  salad: { grams: 120, measure: '1 salad serving (120g)', measureAr: 'سلطة (120 جم)' },
...
export const PORTION_OVERRIDES: Record<string, Portion> = {
  ...
  'Scrambled Eggs and Turkey Bacon': { grams: 120, measure: '2 eggs + 2 turkey bacon (120g)' },
  ...
  'BBQ Beef Ribs': { grams: 250, measure: '5 ribs (250g)' },
  ...
  'Avocado & Turkey Bacon': { grams: 150, measure: '1 plate (150g)' },
  ...
  'Turkey Bacon-Wrapped Chicken Thighs': { grams: 250, measure: '2 thighs (250g)' },
...
export const CUISINE_GROUPS: CuisineGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'intermittent_fasting', nameAr: 'صيام متقطع', nameEn: 'Intermittent Fasting' },
    ],
  },
];
...
export const CUISINE_FLAGS: Record<string, string> = {
  ...
  african: '🌍', mediterranean: 'MED', keto: 'KETO', high_protein: 'HP', vegetarian: 'VEG', vegan: 'VEGAN', gluten_free: 'GF', low_carb: 'LC', dash: 'DASH', intermittent_fasting: 'IF',
};
...
export const FRUITS: FruitJuiceInfo[] = [
  { name_en: 'Apple', name_ar: 'تفاحة', calories: 95, protein: 0.5, carbs: 25.5, fat: 0.4, mealType: 'fruit', type: 'fruit', benefits: 'Rich in fiber & Vitamin C' },
  { name_en: 'Banana', name_ar: 'موزة', calories: 105, protein: 1.3, carbs: 26.9, fat: 0.4, mealType: 'fruit', type: 'fruit', benefits: 'Potassium & natural energy' },
  ...
  { name_en: 'Mango', name_ar: 'مانجو', calories: 99, protein: 1.4, carbs: 24.8, fat: 0.6, mealType: 'fruit', type: 'fruit', benefits: 'Rich in Vitamin A & C' },
  { name_en: 'Strawberries', name_ar: 'فراولة', calories: 49, protein: 1, carbs: 11.7, fat: 0.5, mealType: 'fruit', type: 'fruit', benefits: 'Vitamin C & antioxidants' },
  { name_en: 'Watermelon', name_ar: 'بطيخ', calories: 84, protein: 1.7, carbs: 21.1, fat: 0.4, mealType: 'fruit', type: 'fruit', benefits: 'Hydration & lycopene' },
  { name_en: 'Pineapple', name_ar: 'أناناس', calories: 83, protein: 0.9, carbs: 21.6, fat: 0.2, mealType: 'fruit', type: 'fruit', benefits: 'Bromelain & Vitamin C' },
  { name_en: 'Kiwi', name_ar: 'كيوي', calories: 46, protein: 0.9, carbs: 11.2, fat: 0.4, mealType: 'fruit', type: 'fruit', benefits: 'Vitamin C & fiber' },
  { name_en: 'Avocado', name_ar: 'أفوكادو', calories: 160, protein: 2, carbs: 8.5, fat: 14.7, mealType: 'fruit', type: 'fruit', benefits: 'Healthy fats & potassium' },
  { name_en: 'Grapes', name_ar: 'عنب', calories: 63, protein: 0.7, carbs: 16.7, fat: 0.1, mealType: 'fruit', type: 'fruit', benefits: 'Antioxidants & quick energy' },
  { name_en: 'Peach', name_ar: 'خوخ', calories: 47, protein: 1.1, carbs: 11.4, fat: 0.3, mealType: 'fruit', type: 'fruit', benefits: 'Vitamins A & C' },
  { name_en: 'Pear', name_ar: 'كمثرى', calories: 68, protein: 0.4, carbs: 18.2, fat: 0.2, mealType: 'fruit', type: 'fruit', benefits: 'Fiber & Vitamin C' },
  { name_en: 'Blueberries', name_ar: 'توت أزرق', calories: 84, protein: 1.1, carbs: 21.5, fat: 0.5, mealType: 'fruit', type: 'fruit', benefits: 'Antioxidants' },
  { name_en: 'Raspberries', name_ar: 'توت', calories: 62, protein: 1.4, carbs: 14.3, fat: 0.8, mealType: 'fruit', type: 'fruit', benefits: 'Fiber & Vitamin C' },
  { name_en: 'Blackberries', name_ar: 'عليق أسود', calories: 52, protein: 1.7, carbs: 11.5, fat: 0.6, mealType: 'fruit', type: 'fruit', benefits: 'Antioxidants & fiber' },
  { name_en: 'Cherries', name_ar: 'كرز', calories: 76, protein: 1.3, carbs: 19.2, fat: 0.2, mealType: 'fruit', type: 'fruit', benefits: 'Melatonin & antioxidants' },
  { name_en: 'Pomegranate', name_ar: 'رمان', calories: 100, protein: 2, carbs: 22.4, fat: 1.4, mealType: 'fruit', type: 'fruit', benefits: 'Polyphenol powerhouse' },
  { name_en: 'Papaya', name_ar: 'بابايا', calories: 60, protein: 0.7, carbs: 15.1, fat: 0.4, mealType: 'fruit', type: 'fruit', benefits: 'Digestive enzymes & Vitamin C' },
  { name_en: 'Guava', name_ar: 'جوافة', calories: 68, protein: 2.6, carbs: 14.3, fat: 1, mealType: 'fruit', type: 'fruit', benefits: 'Vitamin C champion' },
  { name_en: 'Cantaloupe', name_ar: 'شمام', calories: 41, protein: 1, carbs: 9.8, fat: 0.2, mealType: 'fruit', type: 'fruit', benefits: 'Vitamin A & hydration' },
  { name_en: 'Honeydew Melon', name_ar: 'قندولة', calories: 43, protein: 0.6, carbs: 10.9, fat: 0.2, mealType: 'fruit', type: 'fruit', benefits: 'Hydration & Vitamin C' },
  { name_en: 'Plum', name_ar: 'برقوق', calories: 55, protein: 0.8, carbs: 13.7, fat: 0.3, mealType: 'fruit', type: 'fruit', benefits: 'Fiber & Vitamin C' },
  { name_en: 'Apricot', name_ar: 'مشمش', calories: 58, protein: 1.7, carbs: 13.3, fat: 0.5, mealType: 'fruit', type: 'fruit', benefits: 'Vitamin A & fiber' },
  { name_en: 'Fig', name_ar: 'تين', calories: 89, protein: 0.9, carbs: 23, fat: 0.4, mealType: 'fruit', type: 'fruit', benefits: 'Fiber & minerals' },
  { name_en: 'Dates (3 pcs)', name_ar: 'تمر (3 حبات)', calories: 166, protein: 1.1, carbs: 45, fat: 0.1, mealType: 'fruit', type: 'fruit', benefits: 'Natural energy & fiber' },
  { name_en: 'Lemon', name_ar: 'ليمون', calories: 35, protein: 1.3, carbs: 11.2, fat: 0.4, mealType: 'fruit', type: 'fruit', benefits: 'Vitamin C boost' },
  { name_en: 'Lime', name_ar: 'ليمون أخضر', calories: 36, protein: 0.8, carbs: 12.6, fat: 0.2, mealType: 'fruit', type: 'fruit', benefits: 'Vitamin C & refreshment' },
  { name_en: 'Grapefruit', name_ar: 'جريب فروت', calories: 50, protein: 0.9, carbs: 12.8, fat: 0.2, mealType: 'fruit', type: 'fruit', benefits: 'Vitamin C & fiber' },
  { name_en: 'Starfruit', name_ar: 'فاكهة النجمة', calories: 37, protein: 1.2, carbs: 8, fat: 0.4, mealType: 'fruit', type: 'fruit', benefits: 'Low-sugar Vitamin C' },
  ...
  { name_en: 'Passion Fruit', name_ar: 'فاكهة الآلام', calories: 97, protein: 2.2, carbs: 23.4, fat: 0.7, mealType: 'fruit', type: 'fruit', benefits: 'Fiber & Vitamin C' },
  { name_en: 'Coconut (fresh)', name_ar: 'جوز هند طازج', calories: 425, protein: 4, carbs: 18.2, fat: 40.2, mealType: 'fruit', type: 'fruit', benefits: 'Healthy MCT fats' },
  { name_en: 'Cranberries', name_ar: 'توت بري', calories: 55, protein: 0.5, carbs: 14.6, fat: 0.2, mealType: 'fruit', type: 'fruit', benefits: 'Antioxidants' },
];

export const JUICES: FruitJuiceInfo[] = [
  { name_en: 'Orange Juice', name_ar: 'عصير برتقال', calories: 90, protein: 1.4, carbs: 20.8, fat: 0.4, mealType: 'juice', type: 'juice', benefits: 'Vitamin C & potassium' },
  { name_en: 'Mango Juice', name_ar: 'عصير مانجو', calories: 108, protein: 0.8, carbs: 26.4, fat: 0.4, mealType: 'juice', type: 'juice', benefits: 'Vitamin A & C' },
  { name_en: 'Strawberry Juice', name_ar: 'عصير فراولة', calories: 62, protein: 0.8, carbs: 15.2, fat: 0.2, mealType: 'juice', type: 'juice', benefits: 'Rich in Vitamin C' },
  { name_en: 'Lemon Juice', name_ar: 'عصير ليمون', calories: 44, protein: 0.8, carbs: 11, fat: 0.2, mealType: 'juice', type: 'juice', benefits: 'Vitamin C & antioxidants' },
  { name_en: 'Carrot Juice', name_ar: 'عصير جزر', calories: 80, protein: 1.8, carbs: 18.6, fat: 0.2, mealType: 'juice', type: 'juice', benefits: 'Beta-carotene (Vitamin A)' },
  { name_en: 'Pomegranate Juice', name_ar: 'عصير رمان', calories: 108, protein: 0.4, carbs: 27.2, fat: 0.6, mealType: 'juice', type: 'juice', benefits: 'Polyphenols & immunity' },
  { name_en: 'Guava Juice', name_ar: 'عصير جوافة', calories: 112, protein: 0.4, carbs: 27, fat: 0.2, mealType: 'juice', type: 'juice', benefits: 'Vitamin C champion' },
  { name_en: 'Apple Juice', name_ar: 'عصير تفاح', calories: 92, protein: 0.2, carbs: 22.6, fat: 0.2, mealType: 'juice', type: 'juice', benefits: 'Quick natural energy' },
  { name_en: 'Grape Juice', name_ar: 'عصير عنب', calories: 120, protein: 0.8, carbs: 29.6, fat: 0.2, mealType: 'juice', type: 'juice', benefits: 'Resveratrol antioxidants' },
  { name_en: 'Pineapple Juice', name_ar: 'عصير أناناس', calories: 106, protein: 0.8, carbs: 25.8, fat: 0.2, mealType: 'juice', type: 'juice', benefits: 'Bromelain & Vitamin C' },
  { name_en: 'Watermelon Juice', name_ar: 'عصير بطيخ', calories: 76, protein: 1.2, carbs: 19, fat: 0.2, mealType: 'juice', type: 'juice', benefits: 'Hydration & lycopene' },
  { name_en: 'Tomato Juice', name_ar: 'عصير طماطم', calories: 34, protein: 1.6, carbs: 7.8, fat: 0.1, mealType: 'juice', type: 'juice', benefits: 'Lycopene & Vitamin K' },
  { name_en: 'Cranberry Juice', name_ar: 'عصير توت بري', calories: 116, protein: 0.8, carbs: 30.6, fat: 0.2, mealType: 'juice', type: 'juice', benefits: 'Urinary tract health' },
  { name_en: 'Grapefruit Juice', name_ar: 'عصير جريب فروت', calories: 78, protein: 1, carbs: 18.4, fat: 0.2, mealType: 'juice', type: 'juice', benefits: 'Vitamin C & metabolism' },
  { name_en: 'Mixed Berry Juice', name_ar: 'عصير توت مشكل', calories: 76, protein: 0.6, carbs: 18, fat: 0.2, mealType: 'juice', type: 'juice', benefits: 'Antioxidant blend' },
  { name_en: 'Peach Juice', name_ar: 'عصير خوخ', calories: 88, protein: 0.8, carbs: 23.4, fat: 0.1, mealType: 'juice', type: 'juice', benefits: 'Vitamins & soft fiber' },
  { name_en: 'Papaya Juice', name_ar: 'عصير بابايا', calories: 80, protein: 0.6, carbs: 20, fat: 0.1, mealType: 'juice', type: 'juice', benefits: 'Digestive enzymes & Vitamin C' },
  { name_en: 'Coconut Water', name_ar: 'ماء جوز الهند', calories: 48, protein: 1.8, carbs: 9.3, fat: 0.5, mealType: 'juice', type: 'juice', benefits: 'Electrolytes & hydration' },
  { name_en: 'Multi-Fruit Cocktail', name_ar: 'كوكتيل فواكه', calories: 100, protein: 0.4, carbs: 24, fat: 0.1, mealType: 'juice', type: 'juice', benefits: 'Vitamin C mix' },
  { name_en: 'Avocado Smoothie', name_ar: 'سموثي أفوكادو', calories: 188, protein: 2.5, carbs: 30, fat: 6.3, mealType: 'juice', type: 'juice', benefits: 'Healthy fats & energy' },
  { name_en: 'Sugarcane Juice', name_ar: 'عصير قصب', calories: 140, protein: 0, carbs: 36, fat: 0, mealType: 'juice', type: 'juice', benefits: 'Quick energy & electrolytes' },
];
