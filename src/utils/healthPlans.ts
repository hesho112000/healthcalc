...
const buildMealsFromCuisine = (cuisine?: string): PlanMealItem[] => {
  const FOODS: Array<{ name_en: string; name_ar: string; calories: number; protein: number; carbs: number; fat: number; cuisine: string[] }> = [
    ...
    { name_en: 'Hummus + Pita', name_ar: 'حمص وخبز', calories: 250, protein: 10, carbs: 30, fat: 10, cuisine: ['lebanese'] },
    { name_en: 'Lentil Soup', name_ar: 'شوربة عدس', calories: 230, protein: 18, carbs: 35, fat: 2, cuisine: ['lebanese', 'egyptian'] },
    ...
    { name_en: 'Falafel Bowl', name_ar: 'طبق فلافل', calories: 450, protein: 15, carbs: 50, fat: 22, cuisine: ['lebanese'] },
    ...
    { name_en: 'Couscous Salad', name_ar: 'سلطة كسكس', calories: 280, protein: 10, carbs: 42, fat: 6, cuisine: ['mediterranean', 'lebanese'] },
    { name_en: 'كشري مصري', name_ar: 'كشري مصري', calories: 354, protein: 13.1, carbs: 62.8, fat: 5.4, cuisine: ['egyptian'] },
    { name_en: 'Ful Medames', name_ar: 'فول مدمس', calories: 340, protein: 18, carbs: 40, fat: 12, cuisine: ['egyptian', 'lebanese'] },
    { name_en: 'ملوخية بالفراخ', name_ar: 'ملوخية بالفراخ', calories: 285, protein: 35.2, carbs: 9.2, fat: 7.1, cuisine: ['egyptian'] },
    ...
    { name_en: 'Fattoush Salad', name_ar: 'سلطة فتوش', calories: 180, protein: 5, carbs: 18, fat: 10, cuisine: ['lebanese'] },
    { name_en: 'Shawarma Plate', name_ar: 'طبق شاورما', calories: 500, protein: 30, carbs: 35, fat: 24, cuisine: ['lebanese'] },
  ];
