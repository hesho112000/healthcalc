...
export const FOODS_DATABASE: FoodItem[] = [
  { name: 'Grilled Chicken Breast', name_en: 'Grilled Chicken Breast', calories: 165, protein: 31, carbs: 0, fat: 3.6, category: 'protein', cuisine: ['american', 'mediterranean', 'high_protein'], portion: '150g' },
  { name: 'Salmon Fillet', name_en: 'Salmon Fillet', calories: 208, protein: 20, carbs: 0, fat: 13, category: 'protein', cuisine: ['mediterranean', 'asian', 'keto', 'high_protein'], portion: '150g' },
  ...
  { name: 'Avocado', name_en: 'Avocado', calories: 240, protein: 3, carbs: 12, fat: 22, category: 'fruit', cuisine: ['mexican', 'mediterranean', 'keto'], portion: '1 whole' },
  { name: 'Greek Yogurt', name_en: 'Greek Yogurt', calories: 100, protein: 17, carbs: 6, fat: 0.7, category: 'dairy', cuisine: ['mediterranean', 'high_protein'], portion: '170g' },
  ...
  { name: 'Chicken Tikka Masala', name_en: 'Chicken Tikka Masala', calories: 430, protein: 30, carbs: 20, fat: 25, category: 'protein', cuisine: ['indian', 'high_protein'], portion: '1 serving' },
  ...
  { name: 'Eggs (2 large)', name_en: 'Eggs (2 large)', calories: 143, protein: 13, carbs: 1, fat: 10, category: 'protein', cuisine: ['american', 'mediterranean', 'keto', 'high_protein'], portion: '2 large' },
  ...
  { name: 'Almonds', name_en: 'Almonds', calories: 164, protein: 6, carbs: 6, fat: 14, category: 'nuts', cuisine: ['mediterranean', 'indian', 'keto'], portion: '1oz (28g)' },
  { name: 'Broccoli', name_en: 'Broccoli', calories: 55, protein: 3.7, carbs: 11, fat: 0.6, category: 'vegetable', cuisine: ['asian', 'mediterranean', 'keto'], portion: '1 cup' },
  { name: 'Tuna (canned)', name_en: 'Tuna (canned)', calories: 128, protein: 26, carbs: 0, fat: 2.5, category: 'protein', cuisine: ['american', 'mediterranean', 'keto', 'high_protein'], portion: '1 can' },
  ...
  { name: 'Pasta Bolognese', name_en: 'Pasta Bolognese', calories: 480, protein: 25, carbs: 55, fat: 15, category: 'grain', cuisine: ['italian'], portion: '1 plate' },
  { name: 'Margherita Pizza', name_en: 'Margherita Pizza', calories: 400, protein: 18, carbs: 42, fat: 16, category: 'grain', cuisine: ['italian'], portion: '2 slices' },
  { name: 'Risotto', name_en: 'Risotto', calories: 380, protein: 12, carbs: 50, fat: 12, category: 'grain', cuisine: ['italian'], portion: '1 cup' },
  { name: 'Grilled Steak', name_en: 'Grilled Steak', calories: 350, protein: 40, carbs: 0, fat: 18, category: 'protein', cuisine: ['american', 'high_protein'], portion: '200g' },
  { name: 'Cottage Cheese', name_en: 'Cottage Cheese', calories: 110, protein: 14, carbs: 5, fat: 4, category: 'dairy', cuisine: ['high_protein'], portion: '150g' },
  { name: 'Whey Protein Shake', name_en: 'Whey Protein Shake', calories: 120, protein: 25, carbs: 3, fat: 1, category: 'protein', cuisine: ['high_protein'], portion: '1 scoop' },
  { name: 'Paneer Tikka', name_en: 'Paneer Tikka', calories: 320, protein: 22, carbs: 8, fat: 22, category: 'protein', cuisine: ['indian', 'high_protein'], portion: '1 serving' },
  { name: 'Butter Chicken', name_en: 'Butter Chicken', calories: 480, protein: 28, carbs: 16, fat: 32, category: 'protein', cuisine: ['indian'], portion: '1 serving' },
  { name: 'Pad Thai', name_en: 'Pad Thai', calories: 420, protein: 18, carbs: 50, fat: 14, category: 'grain', cuisine: ['asian'], portion: '1 plate' },
  { name: 'Caesar Salad', name_en: 'Caesar Salad', calories: 350, protein: 22, carbs: 12, fat: 24, category: 'vegetable', cuisine: ['american', 'mediterranean'], portion: '1 bowl' },
  { name: 'Steak & Eggs', name_en: 'Steak & Eggs', calories: 450, protein: 42, carbs: 2, fat: 28, category: 'protein', cuisine: ['american', 'keto', 'high_protein'], portion: '1 plate' },
  { name: 'Keto Salmon Bowl', name_en: 'Keto Salmon Bowl', calories: 380, protein: 30, carbs: 5, fat: 26, category: 'protein', cuisine: ['keto', 'mediterranean'], portion: '1 bowl' },
  { name: 'Cheese Omelette', name_en: 'Cheese Omelette', calories: 300, protein: 20, carbs: 2, fat: 22, category: 'protein', cuisine: ['american', 'italian', 'keto', 'high_protein'], portion: '3 eggs' },
  { name: 'Grilled Vegetables', name_en: 'Grilled Vegetables', calories: 120, protein: 4, carbs: 14, fat: 6, category: 'vegetable', cuisine: ['mediterranean', 'italian'], portion: '1 plate' },
  { name: 'Caesar Chicken Wrap', name_en: 'Caesar Chicken Wrap', calories: 380, protein: 28, carbs: 30, fat: 14, category: 'protein', cuisine: ['american'], portion: '1 wrap' },
  { name: 'Tofu Stir Fry', name_en: 'Tofu Stir Fry', calories: 280, protein: 16, carbs: 18, fat: 16, category: 'protein', cuisine: ['asian'], portion: '1 plate' },
];
