...
export const page4: SeoPageData = {
  ...
  samplePlan: {
    ...
    tips: {
      ...
      ar: ['تناول أطعمة منخفضة المؤشر الجلايسيمي لمستقرة الأنسولين', 'أضف أوميغا 3 يومياً (سلمون، جوز، بذور الكتان)', 'التدريب على المقاومة 3 مرات أسبوعياً يحسن حساسية الأنسولين', 'ควบคุม التوتر - الكورتيزول يزيد أعراض PCOS', 'تجنب السكر المعالج والكربوهيدرات المكررة', 'فكر في مكمل Inositol (استشر طبيبك)'],
    },
  },
