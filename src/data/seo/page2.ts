...
export const page2: SeoPageData = {
  ...
  description: {
    ...
    ar: [
      'ماريا معلمة في 40 سنة تم تشخيصها مؤخراً بداء السكري من النوع الثاني. قياس HbA1c هو 7.2% والسكر الترشحي كان 142 ملغ/ديسيلتر. أوصى مقدم الرعاية الصحية الخاص بها بتغييرات غذائية وممارسة الرياضة.',
