...
export const page6: SeoPageData = {
  ...
  samplePlan: {
    ...
    tips: {
      ...
      es: ['Enfocate en calcio (1,200mg/dia) y Vitamina D (800-1000 UI/dia)', 'Empieza cada sesion con 5 min de calentamiento', 'Usa ejercicios con silla para entrenar equilibrio', 'Come alimentos antiinflamatorios: pescado graso, frutos rojos', 'Mantente hidratado - los mayores tienen menos sed', 'Hazte densitometrias oseas segun recomiende tu profesional de la salud'],
      ar: ['ركز على الكالسيوم (1,200 ملغ/يوم) وفيتامين D (800-1000 وحدة/يوم)', 'ابدأ كل جلسة بـ 5 دقائق إحماء', 'استخدم تمارين بمساعدة الكرسي لتدريب التوازن', 'تناول أطعمة مضادة للالتهابات: الأسماك الدهنية، التوت، الكركم', 'حافظ على الترطيب - كبار السن يشعرون بالعطش بشكل أقل', 'اخض لفحص كثافة العظام كما يوصي مقدم الرعاية الصحية الخاص بك'],
    },
  },
