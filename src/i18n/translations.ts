...
mbFruits: 'Fruits',
  ...
  de: {
    ...
    homeLabPill: 'LABORAUSWERTUNG',
    homeLabTitle: 'Von Laborwerten zu einem klaren Plan',
    homeLabDesc: 'Geben Sie Werte für Glukose, HbA1c, Blutdruck, Lipide, Leber, Niere, Schilddrüse oder Gicht ein und sehen Sie nützliche Bereiche und nächste Schritte.',
    homeLive: 'LIVE-AUSWERTUNG',
    homeLabH3: 'Verstehen Sie Ihre Zahlen ohne Überforderung.',
    homeBarGlucose: 'Glukose · im Bereich',
    homeBarBp: 'Blutdruck · Stufe 1',
    homeBarChol: 'Cholesterin · optimal',
    homeStartInterpret: 'Laborauswertung starten',
    homeWatchPill: 'SMARTWATCH-SYNC',
    ...
    ltpEngine: 'Smarte Gesundheits-Engine',
    ltpHeroTitle: 'Diabetes- & Bluthochdruck-Suite',
    ltpHeroDesc: 'Geben Sie Ihr Profil und Ihre Laborwerte ein, um sofort personalisierte Ernährungspläne, Trainingsroutinen und Fortschritts-Tracking zu erhalten — alles nach den klinischen ADA- und AHA-Richtlinien.',
    ltpProfileLab: 'Profil & Laborwerte',
    ltpProfileLabSub: 'Geben Sie Ihre Werte für eine personalisierte ADA- & AHA-Auswertung ein',
    ltpUserProfile: 'Nutzerprofil',
    ltpBloodGlucose: 'Blutzucker',
    ltpFastingLabel: 'Nüchtern (mg/dL)',
    ltpFastingRange: 'Normal: 70–99 · Prä: 100–125 · Diabetes: ≥126',
    ltpPostLabel: 'Postprandial 2 Std. (mg/dL)',
    ltpPostRange: 'Normal: <140 · Prä: 140–199 · Diabetes: ≥200',
    ltpHba1cRange: 'Normal: <5,7 % · Prä: 5,7–6,4 % · Diabetes: ≥6,5 %',
    ltpBloodPressure: 'Blutdruck',
    ltpSystolic: 'Systolisch',
    ltpDiastolic: 'Diastolisch',
    ltpSystolicLabel: 'Systolisch (mmHg)',
    ltpDiastolicLabel: 'Diastolisch (mmHg)',
    ltpSysShort: 'Sys',
    ltpDiaShort: 'Dia',
    ltpNormal: 'Normal (AHA):',
    ltpElevated: 'Erhöht:',
    ltpStage1: 'Stufe 1 HTN:',
    ltpStage2: 'Stufe 2 HTN:',
    ltpEvaluate: 'Auswerten & Plan erstellen',
    ltpHide: 'Ausblenden',
    ltpShow: 'Anzeigen',
    ltpProgress: 'Fortschritt',
    ltpGlucose: 'Glukose',
    ltpRisk: 'Risiko',
    ltpDailyTargets: 'Ihre täglichen Ziele',
    ltpTargetsSub: 'Berechnet aus Alter, Gewicht, Größe und Aktivitätslevel',
    ltpProtein: 'Protein:',
    ltpCarbs: 'Kohlenhydrate:',
    ltpFat: 'Fett:',
    ltpDiabetesPlan: 'Diabetes-Managementplan',
    ltpDiaSub: 'Nach ADA-Richtlinien · Niedriger GI · Kohlenhydrat-bilanziert · Altersangepasst',
    ltpFree: 'Kostenlos',
    ltpGlucoseProfile: 'Glukoseprofil',
    ltpStatus: 'Status',
    ltpADATargets: 'ADA-Zielwerte',
    ltpPostMeal: 'Nach dem Essen',
    ltpCarbPerMeal: 'KH/Mahlzeit',
    ltpGITarget: 'GI-Ziel',
    ltpCarbBudget: 'Kohlenhydrat-Budget',
    ltpFiberGoal: 'Ballaststoff-Ziel',
    ltpDiaPlan30: '30-Tage-Ernährungs- & Trainingsplan bei Diabetes',
    ltpDiabetesMeals: 'Diabetes-Gerichte',
    ltpADAAligned: 'ADA-konform',
    ltpOpenFullPlan: 'Vollständigen 30-Tage-Plan mit PDF/Druck öffnen',
    ltpDownloadPrint: 'Laden Sie Ihren vollständigen personalisierten Plan herunter oder drucken Sie ihn',
    ltpCompleteExercises: 'Alle Übungen abschließen',
    ltpExerciseProtocol: 'Trainingsprotokoll',
    ltpAgeAdjusted: 'Altersangepasst',
    ltpADAGuidelines: 'ADA-Richtlinien',
    ltpHTPlan: 'Bluthochdruck-Managementplan',
    ltpHTSub: 'Nach AHA-Richtlinien · DASH-Diät · Natriumarm · Gewichtsbewusst',
    ltpBPProfile: 'Blutdruckprofil',
    ltpReading: 'Messwert',
    ltpAHATargets: 'AHA-Zielwerte',
    ltpBPTarget: 'Blutdruckzielwert',
    ltpSodium: 'Natrium',
    ltpPotassium: 'Kalium',
    ltpExercise: 'Übungen',
    ltpBMITarget: 'BMI-Zielwert',
    ltpHTPlan30: '30-Tage-Ernährungs- & Trainingsplan bei Bluthochdruck',
    ltpDASHMeals: 'DASH-Gerichte',
    ltpDASHAligned: 'DASH-konform',
    ltpWeightAware: 'Gewichtsbewusst',
    ltpAHAGuidelines: 'AHA-Richtlinien',
    ltpDailyMealPlan: 'Täglicher Ernährungsplan',
    ltpMealSummary: '{kcal} kcal · Ø-GI: {gi} · Ziel {target} kcal',
    ltpShuffle: 'Mischen',
    ltpDailyTracking: 'Tägliches Tracking',
    ltpMetric: 'Metrisch',
    ltpTarget: 'Zielwert',
    ltpActual: 'Ist',
    ltpStatusSafe: 'Sicher',
    ltpStatusOnTrack: 'Im Plan',
    ltpStatusAttention: 'Erfordert Aufmerksamkeit',
    ltpStatusBelow: 'Unter dem Zielwert',
    ltpStatusOver: 'Über dem Limit',
    ltpProgressTracking: 'Fortschritts-Tracking',
    ltpEntries: '{n} Einträge',
    ltpClearAll: 'Alles löschen',
    ltpNoProgress: 'Noch keine Werte. Klicken Sie auf „{action}“, um Ihren ersten Eintrag zu erfassen.',
    ltpGlucoseTrend: 'Glukose-Trend (letzte 7)',
    ltpPostShort: 'Post.',
    ltpPostprandial: 'Postprandial',
    ltpBPTrend: 'Blutdruck-Trend (letzte 7)',
    ltpFasting: 'Nüchtern',
    ltpWeightTrend: 'Gewichtstrend',
    ltpDate: 'Datum',
    ltpWeight: 'Gewicht',
    ltpClinicalSummary: 'Klinische Zusammenfassung',
    ltpPrintReport: 'Bericht drucken / herunterladen',
    ltpEmailReport: 'Bericht per E-Mail',
    ltpEmailOpened: 'E-Mail-Client geöffnet',
    ltpEmailReady: 'Ihr vollständiger Gesundheitsbericht mit Profil, Plänen und Fortschritt ist zum Senden bereit.',
    ltpEmptyPrompt: 'Geben Sie oben Ihr Profil und Ihre Laborwerte ein und klicken Sie dann auf „{action}“.',
    pmSuiteBadge: 'Advanced Health Suite',
