...
type TranslationKeys = {
  ...
  homeCta: string;
  homeTrustStars: string;
  homeTrustUsers: string;
  homeTrustDoctor: string;
...
export const translations: Record<Exclude<Language, 'de'>, TranslationKeys> & { de: Partial<TranslationKeys> } = {
  en: {
    ...
    homeHeroA: 'Understand Your Body.',
    homeHeroB: 'Transform Your Health.',
    homeHeroC: '',
    homeHeroSub: 'Free BMI, BMR, and TDEE calculators plus advanced medical care plans.',
    homeTrust: 'Trusted frameworks',
    homeStatBmi: 'BMI · healthy',
    homeStatBmr: 'BMR kcal',
    homeHeroEyebrow: 'Your Biological Fingerprint',
    homeCta: 'Calculate My Biological Age 🔥',
    homeTrustStars: '4.9/5 Rating',
    homeTrustUsers: '12,450+ Users',
    homeTrustDoctor: 'Doctor Approved',
    homeHeroBmiCard: 'BMI',
...
mbFruits: 'Fruits',
  ...
  ar: {
    ...
    homeHeroB: 'غيّر صحتك.',
    homeHeroC: '',
    homeHeroSub: 'حاسبات مجانية للوزن والكتلة العضلية، بالإضافة إلى خطط رعاية طبية متقدمة.',
    homeTrust: 'أطر مرجعية موثوقة',
    homeStatBmi: 'BMI · صحي',
    homeStatBmr: 'BMR kcal',
    homeHeroEyebrow: 'بصمتك الحيوية',
    homeCta: 'احسب عمرك البيولوجي 🔥',
    homeTrustStars: 'تقييم 4.9/5',
    homeTrustUsers: '+12,450 مستخدم',
    homeTrustDoctor: 'معتمد من الأطباء',
  ...
  de: {
    ...
    heroSubtitle: 'Kostenlose BMI-, BMR- und TDEE-Rechner sowie erweiterte medizinische Versorgung bei Diabetes, Bluthochdruck, Cholesterin und Gicht.',
    heroCta: 'Berechnen Sie mein biologisches Alter',
    trustRating: 'Benutzerbewertung',
    trustRatingValue: '4.9 / 5',
    trustUsers: 'Aktive Nutzer',
    trustUsersValue: '12,450+',
    trustDoctor: 'Von Ärzten empfohlen',
