...
const premiumContent: Record<string, ConditionData> = {
  ...
  kidney: {
    mealPlan: [{ meal: 'Breakfast', calories: 330, items: ['White bread (2)', 'Cream cheese (2 tbsp)', 'Blueberries (50g)', 'Herbal tea'], tips: 'Limit potassium and phosphorus' }, { meal: 'Snack', calories: 120, items: ['Unsalted crackers (6)', 'Cucumber slices'], tips: 'Low-sodium snack' }, { meal: 'Lunch', calories: 400, items: ['Grilled chicken (100g)', 'White pasta (120g)', 'Green beans', 'Olive oil dressing'], tips: 'Control protein with healthcare guidance' }, { meal: 'Dinner', calories: 370, items: ['Egg whites (3)', 'White rice (100g)', 'Lettuce & cabbage salad', 'Apple (small)'], tips: 'Low-potassium fruits' }],
...
const LegacyAdvancedCarePage: React.FC = () => {
  ...
  const CONDITION_MACROS: Record<string, MealMacros> = {
    ...
    liver: { proteinRatio: 0.25, carbsRatio: 0.5, fatRatio: 0.25 },
  };
  const builderMacros: MealMacros | undefined = firstSelected ? CONDITION_MACROS[firstSelected] : undefined;
      ...
      <div className="page-hero page-hero-light">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10 md:py-14">
          <div className="grid lg:grid-cols-[1.05fr_.95fr] gap-8 items-center">
            ...
            <div className="page-anime"><IconScene icon={firstSelected === 'diabetes' || firstSelected === 'cholesterol' ? Microscope : HeartPulse} color={firstSelected === 'diabetes' || firstSelected === 'cholesterol' ? '#10b981' : '#8b5cf6'} large /></div>
          </div>
        </div>
      </div>
