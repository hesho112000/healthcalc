...
const AdvancedCareWizardPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    try {
      ...
      if (parsed.goal && typeof parsed.goal === 'object') setGoal(normalizeGoal(parsed.goal));
...
${conditionTags}
  ...
  return (
    <div className="min-h-screen bg-[#FDFBF7] pb-28" dir={dir}>
      ...
      {toast && (
        <div className="fixed bottom-24 inset-x-0 z-50 flex justify-center px-4 pointer-events-none" role="status" aria-live="polite" aria-atomic="true">
