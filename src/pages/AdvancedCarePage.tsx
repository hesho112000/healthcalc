...
const conditions: { id: ConditionId; icon: string; ar: string; en: string; desc: string; interp: string }[] = [
  { id: 'diabetes', icon: '🩸', ar: 'سكر', en: 'Diabetes', desc: 'مرض السكري يؤثر على تنظيم سكر الدم. التحكم في الكربوهيدرات والنشويات ضروري للحفاظ على مستويات مستقرة.', interp: 'HbA1c أقل من 5.7% طبيعي، من 5.7 إلى 6.4% مقدمات سكري، و6.5% أو أكثر يشير إلى سكري. سكر الصائم 126 mg/dL أو أكثر مؤشر للسكري.' },
  { id: 'hypertension', icon: '💗', ar: 'ضغط', en: 'Hypertension', desc: 'ارتفاع ضغط الدم يزيد الضغط على القلب والأوعية. تقليل الملح والحفاظ على وزن صحي أساسيان.', interp: 'قراءة أقل من 120/80 مم زئبق طبيعية، و130/80 أو أكثر تُعد ارتفاعاً في ضغط الدم.' },
  { id: 'cholesterol', icon: '🫀', ar: 'كوليسترول', en: 'Cholesterol', desc: 'الكوليسترول المرتفع يتراكم في الشرايين ويرفع خطر أمراض القلب. الدهون المشبعة هي العدو الرئيسي.', interp: 'الكوليسترول الكلي أقل من 200 mg/dL مرغوب، LDL أقل من 100، HDL فوق 40، والدهون الثلاثية أقل من 150.' },
  { id: 'gout', icon: '🦶', ar: 'نقرس', en: 'Gout', desc: 'النقرس يحدث بسبب تراكم حمض اليوريك. تقليل اللحوم الحمراء والمأكولات عالية البيورين يخفف النوبات.', interp: 'حمض اليوريك حتى 6.8 mg/dL طبيعي، وأعلى من ذلك يزيد خطر نوبات النقرس.' },
  { id: 'liver', icon: '🧡', ar: 'كبد', en: 'Liver health', desc: 'صحة الكبد تنعكس على التمثيل الغذائي. الدهون الزائدة والسكر الزائد يثقلان الكبد.', interp: 'ALT طبيعي 7–56 U/L وAST 10–40 U/L، والارتفاع يشير إلى إجهاد كبدي.' },
  { id: 'kidney', icon: '🫘', ar: 'كلى', en: 'CKD kidney', desc: 'الكلى ترشح الدم وتوازن السوائل. التحكم في البروتين والصوديوم والبوتاسيوم يحميها.', interp: 'eGFR فوق 90 ml/min طبيعي، والكرياتينين 0.6–1.3 mg/dL. انخفاض eGFR يشير إلى ضعف وظائف الكلى.' },
  { id: 'thyroid', icon: '🦋', ar: 'غدة درقية', en: 'Thyroid', desc: 'الغدة الدرقية تتحكم في معدل الأيض. الخلل فيها يسبب تغيرات في الوزن والطاقة.', interp: 'TSH طبيعي 0.4–4.0 mIU/L، وارتفاعه يشير إلى كسل بالغدة وانخفاضه إلى فرط نشاط.' },
  { id: 'ibs', icon: '🌿', ar: 'قولون', en: 'IBS', desc: 'متلازمة القولون العصبي تؤثر على الجهاز الهضمي. لا يوجد تحليل محدد، ونعتمد على الأعراض والاستجابة الغذائية.', interp: 'لا يوجد تحليل محدد — سنقيم الأعراض ونرشح نظاماً غذائياً مريحاً للقولون.' },
];
