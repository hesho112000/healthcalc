...
import { privacyPolicyDocs, getLegalDoc } from '../i18n/legal';

const PrivacyPolicy: React.FC = () => {
  const { language, t, dir } = useLanguage();
  const doc = getLegalDoc(language, privacyPolicyDocs);

  return (
    <div className="min-h-screen bg-[#f8fafc]" dir={dir}>
      <SEO title={t('seo.privacy.title')} description={t('seo.privacy.description')} url="/privacy" />
