// Validates scripts/libya-95-proposal.json against:
...
const proposal = JSON.parse(fs.readFileSync(path.join(__dirname, 'libya-95-proposal.json'), 'utf8'));
...
console.log('===== LIBYA 95 PROPOSAL (49+46) VALIDATION =====');
