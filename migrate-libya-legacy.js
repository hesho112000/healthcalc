...
const data = JSON.parse(
  fs.readFileSync(path.join(__dirname, 'src/data/libyan-full-100-USDA.json'), 'utf8'),
);
  ...
  try {
    ...
    const { data: insertedRow, error } = await supabase
      ...
      .insert({
        ...
        meal_type: meal,
        cal_100: cal100,
        protein: d.p ?? d.protein ?? null,
        carbs: d.c ?? d.carbs ?? null,
        fat: d.f ?? d.fat ?? null,
        ...
        source: d.source ?? 'Ø§Ù„Ù…Ø·Ø¨Ø® Ø§Ù„Ø¬Ø²Ø§Ø¦Ø±ÙŠ Ø§Ù„ØªÙ‚Ù„ÙŠØ¯ÙŠ',
